                  ...
                  data.read(
                    ...
                    (err3, userData) => {
                      if (!err3 && userData) {
                        ...
                        const userChecks = tyof(userObject.checks) === "object" && userObject.checks instanceof Array ? userObject.checks : [];
                        ...
                        if (checkPosition > -1) {
                          ...
                          callback(500, {
                            error: "The check id that you are trying to remove is not found in user's list of checks!",
                          });
                        }
                      } else {
                        callback(500, {
